...
public class UpdateNameActivity extends AppCompatActivity {
    private final String TAG = "UPDATE NAME";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.updateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String newName = editField.getText().toString();
                userViewModel.updateUserName(userId, newName);
                Toast toast = Toast.makeText(getApplicationContext(), "User Name updated successfully", Toast.LENGTH_LONG);
                toast.show();
                finish();
            }
        });
