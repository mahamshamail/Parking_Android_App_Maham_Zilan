...
public class UpdateContactNumberActivity extends AppCompatActivity {
    private final String TAG = "UPDATE NUMBER";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.updateBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                userViewModel.updateUserContactNumber(userId, newEmail);
                Toast toast = Toast.makeText(getApplicationContext(), "User contact number updated successfully", Toast.LENGTH_LONG);
                toast.show();
                finish();
            }
        });
